...
make it obtain current selection using var selectedIds = uidoc.GetSelectionIds();
make it display user a datagrid to choose workset to change using this custom code:
